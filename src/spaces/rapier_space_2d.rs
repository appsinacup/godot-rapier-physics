...
use crate::{
    bodies::{
        rapier_area_2d::RapierArea2D,
        rapier_body_2d::RapierBody2D,
        rapier_collision_object_2d::{
            CollisionObjectType, IRapierCollisionObject2D, RapierCollisionObject2D,
        },
    },
    rapier2d::{
        ...
        user_data::{is_user_data_valid, UserData},
    },
    servers::{
        rapier_physics_singleton_2d::physics_singleton,
...
impl RapierSpace2D {
    pub fn new(rid: Rid) -> Self {
        ...
        let solver_iterations = project_settings
            ...
            .to();
        let contact_recycle_radius = project_settings
            .get_setting_with_override("physics/2d/solver/contact_recycle_radius".into())
            .to();
        let contact_max_separation = project_settings
            .get_setting_with_override("physics/2d/solver/contact_max_separation".into())
            .to();
        let contact_max_allowed_penetration = project_settings
            .get_setting_with_override("physics/2d/solver/contact_max_allowed_penetration".into())
            .to();
        let contact_bias = project_settings
            .get_setting_with_override("physics/2d/solver/default_contact_bias".into())
            .to();
        let constraint_bias = project_settings
            .get_setting_with_override("physics/2d/solver/default_constraint_bias".into())
            .to();
    ...
    pub fn get_removed_collider_info(
        ...
        handle: Handle,
        r_rid: &Rid,
        r_instance_id: &ObjectId,
        r_shape_index: &usize,
        r_type: &CollisionObjectType,
    ) -> bool {
    }
    ...
    pub fn get_contact_recycle_radius(&self) -> real {
        return self.contact_recycle_radius;
    }
    pub fn get_contact_max_separation(&self) -> real {
        return self.contact_max_separation;
    }
    pub fn get_contact_max_allowed_penetration(&self) -> real {
        return self.contact_max_allowed_penetration;
    }
    pub fn get_contact_bias(&self) -> real {
        return self.contact_bias;
    }
    pub fn get_constraint_bias(&self) -> real {
        return self.constraint_bias;
    }
    ...
    pub fn set_last_step(&mut self, step: real) {
        last_step = p_step;
    }
    ...
    pub fn is_debugging_contacts() -> bool {
