...
public:
	...
	void fluid_add_points_and_velocities(const RID &p_fluid, PackedVector2Array points, PackedVector2Array velocities);
	void fluid_delete_points(const RID &p_fluid, PackedInt32Array p_indices);
