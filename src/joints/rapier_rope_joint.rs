...
use crate::types::*;
/// Keeps two bodies within `max_distance` of each other.
pub struct RapierRopeJoint {
    max_distance: real,
    base: RapierJointBase,
}
impl RapierRopeJoint {
    ...
    pub fn new(
        ...
        let handle = physics_engine.joint_create_rope(
            space_handle,
...
impl_rapier_joint_base!(RapierRopeJoint, JointType::MAX);
