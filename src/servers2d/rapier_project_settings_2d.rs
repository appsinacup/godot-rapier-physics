...
#[derive(Debug)]
pub struct RapierProjectSettings2D;

impl RapierProjectSettings2D {
    ...
    pub fn get_solver_max_ccd_substeps() -> i64 {
        RapierProjectSettings2D::get_setting_int(SOLVER_MAX_CCD_SUBSTEPS)
    }

    pub fn get_solver_num_solver_iterations() -> i64 {
        RapierProjectSettings2D::get_setting_int(SOLVER_NUM_ITERATIONS)
    }

    pub fn get_solver_num_additional_friction_iterations() -> i64 {
        RapierProjectSettings2D::get_setting_int(SOLVER_NUM_ADDITIONAL_FRICTION_ITERATIONS)
    }

    pub fn get_solver_num_internal_pgs_iterations() -> i64 {
        RapierProjectSettings2D::get_setting_int(SOLVER_NUM_INTERNAL_PGS_ITERATIONS)
    }

    pub fn get_fluid_gravity_dir() -> Vector2 {
        RapierProjectSettings2D::get_setting_vector2(FLUID_GRAVITY_DIR)
    }

    pub fn get_fluid_gravity_value() -> f64 {
        RapierProjectSettings2D::get_setting_double(FLUID_GRAVITY_VALUE)
    }

    pub fn get_fluid_particle_radius() -> f64 {
        RapierProjectSettings2D::get_setting_double(FLUID_PARTICLE_RADIUS)
    }

    pub fn get_fluid_smoothing_factor() -> f64 {
        RapierProjectSettings2D::get_setting_double(FLUID_SMOOTHING_FACTOR)
    }

    pub fn get_contact_skin() -> f64 {
        RapierProjectSettings2D::get_setting_double(CONTACT_SKIN)
    }
}
