...
cargo clippy --fix --allow-dirty --features="single-dim2,simd-stable,serde-serialize,parallel,experimental-threads,register-docs,api-custom"
export GDRUST_GODOT_BIN="${GDRUST_GODOT_BIN:-/Applications/Godot.app/Contents/MacOS/Godot}"
cargo build --release --features="single-dim2,simd-stable,serde-serialize,parallel,experimental-threads,register-docs,api-custom"
