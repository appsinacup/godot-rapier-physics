...
cargo clippy --fix --allow-dirty --features="single-dim2,serde-serialize,parallel,experimental-threads,register-docs,api-4-7"
cargo build --release --features="single-dim2,serde-serialize,parallel,experimental-threads,register-docs,api-4-7"
