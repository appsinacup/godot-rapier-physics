...
cargo clippy --fix --allow-dirty --features="single-dim3,serde-serialize,parallel,register-docs,api-4-7"
cargo build --release --features="single-dim3,serde-serialize,parallel,register-docs,api-4-7"
