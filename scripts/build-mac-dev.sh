...
cargo build --features="single_dim2,parallel,simd-stable,profiler,convert_pixels_to_meters" --no-default-features
...
cp target/debug/libgodot_rapier.dylib /Users/dragosdaian/Documents/Godot-Physics-Tests/addons/godot-rapier2d/bin/libgodot_rapier.macos.dylib
