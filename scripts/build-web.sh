...
cargo build -Z build-std=panic_abort,std --features="single-dim2,experimental-wasm,wasm-bindgen" --target wasm32-unknown-emscripten --no-default-features # --release
