...
cargo +nightly build -Z build-std=panic_abort,std --release --features="single-dim2,experimental-wasm,wasm-bindgen" --target wasm32-unknown-emscripten --no-default-features
