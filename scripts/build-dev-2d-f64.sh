...
cargo clippy --fix --allow-dirty --features="double-dim2,serde-serialize,test,parallel,experimental-threads,register-docs,api-custom"
...
if [ "${OSTYPE#darwin}" != "$OSTYPE" ]; then
    cargo build --features="double-dim2,serde-serialize,test,parallel,experimental-threads,register-docs,api-custom"
